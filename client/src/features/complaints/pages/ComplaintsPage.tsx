...
const categories = ["HEALTH","MAINTENANCE","ELECTRICITY","PLUMBING","CLEANLINESS","WATER","INTERNET","SECURITY","MESS","OTHER"];
...
export function ComplaintsPage() {
  ...
  return <section className="card">
    ...
    <p>Raise health, maintenance, electricity, plumbing, cleanliness and other hostel concerns. AI will estimate urgency and priority when configured.</p>
